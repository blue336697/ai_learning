...
from machinelearn.common.lab_utils_common import compute_cost
from machinelearn.common.lab_utils_common import dlblue, dlorange, dldarkred, dlmagenta, dlpurple, dlcolors
