...
from machinelearn.common.lab_utils_common import np, plt, dlc, predict_logistic, plot_data, zscore_normalize_features
...
class overfit_example():
    ...
    def linear_regression(self):
        ...
        linear_model = make_pipeline(
            ...
            Ridge(alpha=self.lambda_, max_iter=10000, random_state=0)
        )
        linear_model.fit(self.X_mapped_scaled, self.y)
        ridge = linear_model.named_steps['ridge']  # 最后一步的回归器
        self.w = ridge.coef_.reshape(-1, )
